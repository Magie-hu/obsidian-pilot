...
var LLMWikiPlugin = class extends import_obsidian2.Plugin {
  constructor() {
    super(...arguments);
  ...
  async onload() {
    ...
    if (!this.apiConnected) {
      new import_obsidian2.Notice("\u26A0\uFE0F API \u672A\u8FD0\u884C\uFF0C\u8BF7\u5148\u542F\u52A8\u540E\u7AEF\u670D\u52A1", 5e3);
    }
  }
  async checkConnection() {
    try {
      const resp = await (0, import_obsidian2.requestUrl)(`${API_BASE}/health`);
