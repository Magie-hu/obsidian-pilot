...
def create_index_page(vault_path, template_name):
    """Create the master index page for LLM-Wiki."""
    vault = Path(vault_path).resolve()
    template = FOLDER_TEMPLATES[template_name]
    
    index_content = f"""# LLM-Wiki Knowledge Base

> Bidirectional bridge between LLM-Wiki and Obsidian
